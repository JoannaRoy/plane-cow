...
# (a) Core COW endpoints — commit, discard, status, and session-operations.
#
# These are the only endpoints a harness needs:
#   GET  /api/cow/status/                        — verify COW is live
#   POST /api/cow/commit/                        — commit a full session
#   POST /api/cow/operations/commit/             — partial commit
#   POST /api/cow/operations/discard/            — discard (clean up agent runs)
#   GET  /api/cow/sessions/<id>/operations/      — operation UUIDs for scoring
